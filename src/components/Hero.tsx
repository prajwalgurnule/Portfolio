      ...
      <div className="container mx-auto px-8 py-8 relative z-10">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="relative order-1 md:order-2">
            ...
            <div className="absolute w-24 h-24 bg-yellow-500 bottom-4 left-4 rounded-full animate-floating delay-450" />
            ...
            <img
              ...
              alt="Prajwal Gurnule"
              className="relative w-30 max-w-lg mx-auto rounded-full shadow-2xl transform hover:scale-105 transition-transform duration-500"
            />
          </div>
