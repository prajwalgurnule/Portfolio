        ...
        <div className="container mx-auto max-w-6xl px-8">
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative w-full h-[18rem] md:h-[25rem] overflow-hidden">
              <img
                src="https://leetcard.jacoblin.cool/prajwal_gurnule?theme=dark&font=Inter&ext=activity&border=2&radius=10"
            ...
            <div>
              <h3 className=" text-center text-2xl font-bold text-purple-600 dark:text-purple-400 mb-4">
                My Leetcode Journey
              </h3>
              ...
              <div className="mt-6 flex justify-center">
                <a
                  href="https://leetcode.com/prajwal_gurnule/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 bg-purple-600 text-white px-4 py-2 rounded-lg hover:bg-purple-700 hover:scale-105 transition-all"
                >
